                ...
                <div className='contact__card'>
                    <figure className='contact__mail'>
                        <a href='mailto:joelsanabria11@gmail.com' className='contact__mail--link'>
                            <img src="./src/assets/SocialMedia/maillight.png" alt="Image Mail" className='contact__mail--img' />
                    ...
                    <div className='contact__media'>
                        <figure className='contact__media--figure'>
                            <a href="https://wa.me/+573209028534" target="_blank">
                                <img src="./src/assets/SocialMedia/whatsapp.png" alt="Image WhatsApp" className='contact__media--img' />
                            </a>
                        </figure>
                        <figure className='contact__media--figure'>
                            <a href="https://www.linkedin.com/in/emanuel-gelvez-13020a1b0/" target="_blank">
                            <img src="./src/assets/SocialMedia/linkedln.png" alt="Image Linkedln" className='contact__media--img'/>
                            </a>
                        </figure>
                    </div>
                </div>
