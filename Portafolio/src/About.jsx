        ...
        <section className='about' id='about'>
            ...
            <div className='about__cards'>
                <figure className='about__cards--card'>
                    <img src='/unomas.png' alt="Mas de un anio" className='about__cards--img' />
                ...
                <figure className='about__cards--card'>
                <img src='/graduation-hat2.png' alt="Graduation" className='about__cards--img'/>
                    <p>Egresado como tecnologo en sistemas de la Universidad ECCI y actualmente estudiante de Ingenieria de Software</p>
                </figure>
                <figure className='about__cards--card'>
                <img src='/diploma.png' alt="Graduation" className='about__cards--img'/>
